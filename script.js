const questions = [
  ...
  {
    question: "Which English Queen has the name as a type of plum?",
    answers: [
      { text: "Queen Georgia", correct: false },
      { text: "Queen Elizebeth", correct: false },
